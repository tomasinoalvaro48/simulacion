...
Las estrategias pueden ser de dos enfoques distintos \cite{estrategias_progresion}:
...
\paragraph{Funcionamiento} Consiste en duplicar la apuesta después de cada pérdida. El objetivo es que, si el jugador gana, recupere todas las pérdidas acumuladas en las rondas anteriores más un beneficio adicional equivalente a la apuesta inicial.\cite{martingala}
...
\paragraph{Flujo de caja (1ra corrida)} En la \cref{fig:f1-flujo-caja-martingala-100}, se observa una serie de tiradas donde el capital fluctúa cerca del valor inicial de \$100 antes de una caída abrupta hacia la bancarrota en la tirada 7. Al comparar con la \cref{fig:f2-flujo-caja-martingala-1000}, se ve un periodo de supervivencia más extenso, pero con una pendiente de caída final mucho más pronunciada hacia la tirada 19, evidenciando el riesgo del crecimiento exponencial de la apuesta.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f1-flujo-caja-martingala-100.png}
        \caption{100 tiradas}
        \label{fig:f1-flujo-caja-martingala-100}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f2-flujo-caja-martingala-1000.png}
        \caption{1000 tiradas}
        \label{fig:f2-flujo-caja-martingala-1000}
    \end{subfigure}

    \caption{Flujo de caja de la estrategia Martingala}
    \label{fig:flujo-caja-martingala}
\end{figure}

\paragraph{Dispersión de capital final} La \cref{fig:f3-dispersion-martingala-100} muestra una concentración de resultados finales entre \$140 y \$160, con una franja significativa de bancarrotas cerca de cero. En la \cref{fig:f4-dispersion-martingala-1000}, la cantidad de puntos abajo del capital inicial es mucho más densa, confirmando una mayor frecuencia de fallos acumulados a largo plazo.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f3-dispersion-martingala-100.png}
        \caption{100 tiradas}
        \label{fig:f3-dispersion-martingala-100}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f4-dispersion-martingala-1000.png}
        \caption{1000 tiradas}
        \label{fig:f4-dispersion-martingala-1000}
    \end{subfigure}

    \caption{Dispersión de capital de la estrategia Martingala}
    \label{fig:dispersion-martingala}
\end{figure}

\paragraph{Rendimiento promedio} La \cref{fig:f5-rendimiento-martingala-100} muestra un promedio final de \$92,43, que es una pérdida moderada respecto al capital inicial. En la \cref{fig:f6-rendimiento-martingala-1000}, el promedio cae drásticamente a \$76,15, validando que cuanto más se juega, más se pierde.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f5-rendimiento-martingala-100.png}
        \caption{100 tiradas}
        \label{fig:f5-rendimiento-martingala-100}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f6-rendimiento-martingala-1000.png}
        \caption{1000 tiradas}
        \label{fig:f6-rendimiento-martingala-1000}
    \end{subfigure}

    \caption{Rendimiento promedio de la estrategia Martingala}
    \label{fig:rendimiento-martingala}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f7-ganancia-perdida-martingala.png}
        \caption{Ganancia vs pérdida}
        \label{fig:f7-ganancia-perdida-martingala}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f8-saldo-neto-martingala.png}
        \caption{Saldo neto}
        \label{fig:f8-saldo-neto-martingala}
    \end{subfigure}

    \caption{Análisis con capital infinito de la estrategia Martingala}
    \label{fig:analisis-capital-infinito-martingala}
\end{figure}

\subsubsection{Estrategia Fibonacci}
\paragraph{Flujo de caja (1ra corrida)} La \cref{fig:f9-flujo-caja-fibonacci-100} muestra una volatilidad controlada, donde el flujo de caja se recupera parcialmente retrocediendo 2 posiciones en la secuencia después de cada acierto. En la \cref{fig:f10-flujo-caja-fibonacci-1000}, la racha negativa prolongada termina superando la capacidad de recuperación, resultando en bancarrota en la tirada 40.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f9-flujo-caja-fibonacci-100.png}
        \caption{100 tiradas}
        \label{fig:f9-flujo-caja-fibonacci-100}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f10-flujo-caja-fibonacci-1000.png}
        \caption{1000 tiradas}
        \label{fig:f10-flujo-caja-fibonacci-1000}
    \end{subfigure}

    \caption{Flujo de caja de la estrategia Fibonacci}
    \label{fig:flujo-caja-fibonacci}
\end{figure}

\paragraph{Dispersión de capital final} En la \cref{fig:f11-dispersion-fibonacci-100}, los resultados finales están más dispersos, con bastantes casos por arriba de la línea del capital inicial. En cambio, la \cref{fig:f12-dispersion-fibonacci-1000} muestra cómo la mayoría de las corridas terminan con un capital residual mínimo, agotado por la progresión de la secuencia.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f11-dispersion-fibonacci-100.png}
        \caption{100 tiradas}
        \label{fig:f11-dispersion-fibonacci-100}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f12-dispersion-fibonacci-1000.png}
        \caption{1000 tiradas}
        \label{fig:f12-dispersion-fibonacci-1000}
    \end{subfigure}

    \caption{Dispersión de capital de la estrategia Fibonacci}
    \label{fig:dispersion-fibonacci}
\end{figure}

\paragraph{Rendimiento promedio} En la \cref{fig:f13-rendimiento-fibonacci-100}, se ve un capital promedio final de \$94,39. En la \cref{fig:f14-rendimiento-fibonacci-1000}, el rendimiento disminuye a \$72,07, demostrando que la progresión negativa de Fibonacci no compensa el margen de la casa en sesiones extensas.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f13-rendimiento-fibonacci-100.png}
        \caption{100 tiradas}
        \label{fig:f13-rendimiento-fibonacci-100}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f14-rendimiento-fibonacci-1000.png}
        \caption{1000 tiradas}
        \label{fig:f14-rendimiento-fibonacci-1000}
    \end{subfigure}

    \caption{Rendimiento promedio de la estrategia Fibonacci}
    \label{fig:rendimiento-fibonacci}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f15-ganancia-perdida-fibonacci.png}
        \caption{Ganancia vs pérdida}
        \label{fig:f15-ganancia-perdida-fibonacci}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f16-saldo-neto-fibonacci.png}
        \caption{Saldo neto}
        \label{fig:f16-saldo-neto-fibonacci}
    \end{subfigure}

    \caption{Análisis con capital infinito de la estrategia Fibonacci}
    \label{fig:analisis-capital-infinito-fibonacci}
\end{figure}

\subsubsection{Estrategia D’Alembert}
\paragraph{Flujo de caja (1ra corrida)} La \cref{fig:f17-flujo-caja-dalembert-100} refleja una pérdida lineal constante hasta la bancarrota en la tirada 30. La \cref{fig:f18-flujo-caja-dalembert-1000} muestra un comportamiento parecido, donde pequeñas recuperaciones no logran revertir la tendencia negativa, llegando a la bancarrota en la tirada 38.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f17-flujo-caja-dalembert-100.png}
        \caption{100 tiradas}
        \label{fig:f17-flujo-caja-dalembert-100}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f18-flujo-caja-dalembert-1000.png}
        \caption{1000 tiradas}
        \label{fig:f18-flujo-caja-dalembert-1000}
    \end{subfigure}

    \caption{Flujo de caja de la estrategia D'Alembert}
    \label{fig:flujo-caja-dalembert}
\end{figure}

\paragraph{Dispersión de capital final} La \cref{fig:f19-dispersion-dalembert-100} muestra resultados muy variados, con una gran cantidad de corridas terminando en saldo negativo. En la \cref{fig:f20-dispersion-dalembert-1000}, la dispersión se concentra casi exclusivamente en valores cercanos a cero o negativos.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f19-dispersion-dalembert-100.png}
        \caption{100 tiradas}
        \label{fig:f19-dispersion-dalembert-100}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f20-dispersion-dalembert-1000.png}
        \caption{1000 tiradas}
        \label{fig:f20-dispersion-dalembert-1000}
    \end{subfigure}

    \caption{Dispersión de capital de la estrategia D'Alembert}
    \label{fig:dispersion-dalembert}
\end{figure}

\paragraph{Rendimiento promedio} En la \cref{fig:f21-rendimiento-dalembert-100}, se muestra un promedio final de \$87,17. En la \cref{fig:f22-rendimiento-dalembert-1000}, ese valor disminuye a \$51,15, siendo la caída más agresiva entre las estrategias analizadas.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f21-rendimiento-dalembert-100.png}
        \caption{100 tiradas}
        \label{fig:f21-rendimiento-dalembert-100}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f22-rendimiento-dalembert-1000.png}
        \caption{1000 tiradas}
        \label{fig:f22-rendimiento-dalembert-1000}
    \end{subfigure}

    \caption{Rendimiento promedio de la estrategia D'Alembert}
    \label{fig:rendimiento-dalembert}
\end{figure}

\paragraph{Análisis con capital infinito} La \cref{fig:f23-ganancia-perdida-dalembert}, que corresponde a la ganancia vs pérdida, muestra aumentos importantes después de rachas de fallos; en la \cref{fig:f24-saldo-neto-dalembert}, que corresponde al saldo neto, se observa una recuperación constante gracias a la naturaleza aritmética de sumar los dos extremos. Al final, se logra un saldo neto positivo si no hay límites de capital.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f23-ganancia-perdida-dalembert.png}
        \caption{Ganancia vs pérdida}
        \label{fig:f23-ganancia-perdida-dalembert}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f24-saldo-neto-dalembert.png}
        \caption{Saldo neto}
        \label{fig:f24-saldo-neto-dalembert}
    \end{subfigure}

    \caption{Análisis con capital infinito de la estrategia D'Alembert}
    \label{fig:analisis-capital-infinito-dalembert}
\end{figure}

\subsubsection{Estrategia Paroli}
\paragraph{Flujo de caja (1ra corrida)} Al ser una progresión positiva, la \cref{fig:f25-flujo-caja-paroli-100} muestra picos de ganancia cuando se encadenan aciertos, pero sin caídas exponenciales ante pérdidas. La \cref{fig:f26-flujo-caja-paroli-1000} muestra que, aunque se logren picos de hasta \$250, la varianza estadística termina erosionando el capital inicial a largo plazo.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f25-flujo-caja-paroli-100.png}
        \caption{100 tiradas}
        \label{fig:f25-flujo-caja-paroli-100}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f26-flujo-caja-paroli-1000.png}
        \caption{1000 tiradas}
        \label{fig:f26-flujo-caja-paroli-1000}
    \end{subfigure}

    \caption{Flujo de caja de la estrategia Paroli}
    \label{fig:flujo-caja-paroli}
\end{figure}

\paragraph{Dispersión de capital final} La \cref{fig:f27-dispersion-paroli-100} muestra la cantidad de puntos muy equilibrada alrededor de la línea de capital inicial, con pocas bancarrotas inmediatas. En la \cref{fig:f28-dispersion-paroli-1000}, aunque hay valores altos, se ve una línea densa de corridas en \$0, demostrando que incluso con bajo riesgo por apuesta, el tiempo de juego agota el capital.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f27-dispersion-paroli-100.png}
        \caption{100 tiradas}
        \label{fig:f27-dispersion-paroli-100}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f28-dispersion-paroli-1000.png}
        \caption{1000 tiradas}
        \label{fig:f28-dispersion-paroli-1000}
    \end{subfigure}

    \caption{Dispersión de capital de la estrategia Paroli}
    \label{fig:dispersion-paroli}
\end{figure}

\paragraph{Rendimiento promedio} En la \cref{fig:f29-rendimiento-paroli-100}, el capital promedio final es de \$95,89, el más alto de las 4 estrategias para $n=100$. Pero en la \cref{fig:f30-rendimiento-paroli-1000}, el promedio cae a \$57,89, reforzando que ninguna estrategia supera la ventaja matemática del casino al aumentar la cantidad de ensayos.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f29-rendimiento-paroli-100.png}
        \caption{100 tiradas}
        \label{fig:f29-rendimiento-paroli-100}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f30-rendimiento-paroli-1000.png}
        \caption{1000 tiradas}
        \label{fig:f30-rendimiento-paroli-1000}
    \end{subfigure}

    \caption{Rendimiento promedio de la estrategia Paroli}
    \label{fig:rendimiento-paroli}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f31-ganancia-perdida-paroli.png}
        \caption{Ganancia vs pérdida}
        \label{fig:f31-ganancia-perdida-paroli}
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f32-saldo-neto-paroli.png}
        \caption{Saldo neto}
        \label{fig:f32-saldo-neto-paroli}
    \end{subfigure}

    \caption{Análisis con capital infinito de la estrategia Paroli}
    \label{fig:analisis-capital-infinito-paroli}
\end{figure}

\subsubsection{Convergencia del porcentaje de victorias}
El gráfico de convergencia muestra cómo, a medida que aumenta la cantidad de tiradas, el porcentaje observado de victorias tiende a estabilizarse en el 48,6\% teórico (18/37). Esta estabilización confirma la Ley de los Grandes Números \cite{ley_grandes_numeros} en eventos binarios, proporcionando un marco sólido para comparar los resultados de las estrategias frente al valor esperado.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{f33-convergencia-victorias.png}
  \caption{Convergencia del porcentaje de victorias}
  \label{fig:f33-convergencia-victorias}
\end{figure}
...
\begin{table}[H]
  ...
  \label{tab:comparacion-rendimientos}
\end{table}

Como se ve en el \cref{tab:comparacion-rendimientos}, ninguna de las estrategias pudo mantener el capital inicial de \$100.
...
Esto confirma que, aunque algunas estrategias pueden parecer exitosas en pocas tiradas, la \textbf{Ley de los Grandes Números} \cite{ley_grandes_numeros} garantiza que el flujo de caja del apostador tienda inevitablemente hacia la pérdida a medida que aumenta el número de ensayos de Bernoulli.
